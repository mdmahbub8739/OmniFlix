 ...
 * 1. OrVid — NEW PRIMARY
 * 2. Lumen — primary (Hindi dub preferred)
 * 3. Aurora (Hindi audio)
 * 4. Nebula
 * 5. Stellar (VidRock, enterprise-grade)
 * 6. Eclipse (Hindi dub)
 * 7. Solstice (Hindi dub)
 * 8. Halo (Hindi audio, Multi-Lang server)
 * 9. Orion (Hindi audio, Multi-Lang server)
 * 10. Vega (Hindi audio, Multi-Lang server)
 * =========================================================================
 */
(function (global) {
  'use strict';
  ...
  function defaultChain() {
    ...
    return [
      // 1. NEW PRIMARY (OrVid added here as the default server)
      { name: 'OrVid', kind: 'aurora', opts: { server: 'orvid', lang: 'hi' } },
      ...
      { name: 'Orion', kind: 'aurora', opts: { server: 'ZetPly-[Multi-Lang]', lang: 'hi' } },
